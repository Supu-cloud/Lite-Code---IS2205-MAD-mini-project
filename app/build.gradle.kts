...
dependencies {
    ...
    // For Kotlin Symbol Processing (KSP) if available, but staying compatible with current setup
    // Using kapt/annotationProcessor as a safe default for now
    ...
    // Diff Utils for Incremental Version Control
